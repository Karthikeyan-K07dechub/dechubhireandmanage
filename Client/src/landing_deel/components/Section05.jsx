...
function Section05() {
  ...
  return (
    <section className="w-full tablet:px-xxxs">
      <div
        className="w-full bg-surface-dark rounded-0 tablet:rounded-[20px]"
        style={{
          paddingLeft: "16px",
          paddingRight: "16px",
          paddingTop: "64px",
      ...
      >
        <div className="mx-auto flex w-full max-w-[1312px] flex-col gap-lg tablet:gap-[60px]">
          ...
          <div className="flex flex-col gap-xs">
            <div className="hidden grid-cols-1 gap-md tablet:grid tablet:grid-cols-3">
              {cards.map((card, index) => (
                <div
                  key={card.title}
                  className={`rounded-lg transition-colors flex flex-col justify-between hover:bg-white/5 ${index === 0 ? "bg-white/5" : ""}`}
                  style={{
                    paddingTop: "24px",
                    paddingRight: "24px",
                    paddingBottom: "24px",
          ...
          <div className="flex flex-col overflow-hidden rounded-xl tablet:flex-row tablet:items-stretch h-auto tablet:h-[311px] bg-surface-card-on-dark">
            <div
              className="flex flex-1 flex-col justify-center gap-xxxs py-lg"
              style={{
                paddingLeft: "40px",
                paddingRight: "32px",
              }}
